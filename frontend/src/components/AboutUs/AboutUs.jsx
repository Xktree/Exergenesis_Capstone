        ...
        <React.Fragment>
            <div className="container">
                ...
                <div className="project background">
                    ...
                    <p><strong>Exergenesis</strong> is my capstone project for the Software Engineering Bootcamp here at 
                    <a href="https://devcodecamp.com/" target="_blank"> devCodeCamp</a>
                    </p>
                    <p>I love traveling the world, but sometimes it's hard to gauge exactly where you want to vacation, so why not have it decided for you based on certain criteria?
                    </p>
                </div>
